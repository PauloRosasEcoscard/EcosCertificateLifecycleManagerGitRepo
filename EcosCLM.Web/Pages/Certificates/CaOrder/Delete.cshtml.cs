...
{
    public class DeleteModel : BasePageModel<CaOrderViewModel>
    {
        ...
        public async Task<IActionResult> OnGetAsync(Guid id)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "Error retrieving CA order for deletion.");
                return RedirectToPage("Index");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                TempData["success"] = "CA Order deleted successfully!";
                return RedirectToPage("Index");
            }
            catch (Exception ex)
            {
                TempData["error"] = ex.Message;
                _logger.LogError(ex, "Error deleting CA order.");
                return Page();
            }
        }
    }
