...
{
    public class DeleteModel : BasePageModel<ApprovalTaskViewModel>
    {
        ...
        public async Task<IActionResult> OnGetAsync(Guid id)
        {
            try
            {
                ...
                if (Item == null)
                {
                    TempData["warning"] = "Approval Task not found.";
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "Error retrieving approval task for deletion.");
                return RedirectToPage("Index");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                TempData["success"] = "Approval Task deleted successfully!";
                return RedirectToPage("Index");
            }
            catch (Exception ex)
            {
                TempData["error"] = ex.Message;
                _logger.LogError(ex, "Error deleting approval task.");
                return Page();
            }
        }
    }
