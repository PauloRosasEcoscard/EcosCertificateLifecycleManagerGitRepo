...
{
    public class DeleteModel : BasePageModel<HsmClusterViewModel>
    {
        ...
        public async Task<IActionResult> OnGetAsync(Guid id)
        {
            try
            {
                ...
                if (Item == null)
                {
                    TempData["warning"] = "HSM Cluster not found.";
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "Error retrieving HSM cluster for deletion.");
                return RedirectToPage("Index");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                TempData["success"] = "HSM Cluster deleted successfully!";
                return RedirectToPage("Index");
            }
            catch (Exception ex)
            {
                TempData["error"] = ex.Message;
                _logger.LogError(ex, "Error deleting HSM cluster.");
                return Page();
            }
        }
    }
