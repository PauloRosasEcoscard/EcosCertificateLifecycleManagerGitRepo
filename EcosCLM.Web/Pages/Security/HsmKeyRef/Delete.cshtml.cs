...
{
    public class DeleteModel : BasePageModel<HsmKeyRefViewModel>
    {
        ...
        public async Task<IActionResult> OnGetAsync(Guid id)
        {
            try
            {
                ...
                if (Item == null)
                {
                    TempData["warning"] = "HSM Key Reference not found.";
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "Error retrieving HSM key reference for deletion.");
                return RedirectToPage("Index");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                TempData["success"] = "HSM Key Reference deleted successfully!";
                return RedirectToPage("Index");
            }
            catch (Exception ex)
            {
                TempData["error"] = ex.Message;
                _logger.LogError(ex, "Error deleting HSM key reference.");
                return Page();
            }
        }
    }
