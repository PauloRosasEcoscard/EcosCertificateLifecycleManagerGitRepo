...
namespace EcosCLM.Application.Extensions.Certificates
{
    public static class CaOrderExtension
    {
        ...
        public static async Task<CaOrderViewModel> EditAsync(this ICaOrderRepository repository, CaOrderViewModel model)
        {
            ArgumentNullException.ThrowIfNull(repository);
        ...
        public static async Task<bool> DeleteAsync(this ICaOrderRepository repository, Guid id)
        {
            ArgumentNullException.ThrowIfNull(repository);
