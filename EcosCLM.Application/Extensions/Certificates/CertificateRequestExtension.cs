...
namespace EcosCLM.Application.Extensions.Certificates
{
    public static class CertificateRequestExtension
    {
        ...
        public static async Task<CertificateRequestViewModel> EditAsync(this ICertificateRequestRepository repository, CertificateRequestViewModel model)
        {
            ArgumentNullException.ThrowIfNull(repository);
        ...
        public static async Task<bool> DeleteAsync(this ICertificateRequestRepository repository, Guid id)
        {
            ArgumentNullException.ThrowIfNull(repository);
