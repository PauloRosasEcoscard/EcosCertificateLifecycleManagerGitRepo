...
namespace EcosCLM.Application.Extensions.Certificates
{
    public static class ApprovalTaskExtension
    {
        ...
        public static async Task<ApprovalTaskViewModel> EditAsync(this IApprovalTaskRepository repository, ApprovalTaskViewModel model)
        {
            ArgumentNullException.ThrowIfNull(repository);
        ...
        public static async Task<bool> DeleteAsync(this IApprovalTaskRepository repository, Guid id)
        {
            ArgumentNullException.ThrowIfNull(repository);
