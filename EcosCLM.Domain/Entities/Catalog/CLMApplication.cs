...
namespace EcosCLM.Domain.Entities.Catalog
{
    public class CLMApplication
    {
        ...
        public virtual IEnumerable<ManagedDomain> Domains { get; set; } = new List<ManagedDomain>();
        public virtual IEnumerable<CertificateRequest> CLMApplicationCertificateRequests { get; set; } = new List<CertificateRequest>();
        public virtual IEnumerable<DeploymentTarget> DeploymentTargets { get; set; } = new List<DeploymentTarget>();
    }
}